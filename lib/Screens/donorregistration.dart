...
class _DonorRegisterState extends State<DonorRegister> {
  ...
  void uploadSingleImage() async {
    ...
    String fileUploadFolder = "donor/benecifiarylogo";
  ...
  registerdata() async {
    var data = {
      ...
      "establishmentRegistrationNumber":
          orgregisterno != null ? orgregisterno.toString() : null,
      "establishmentLogoURL": Profile!.path.toString(),
    ...
    print("api call");
    await Api()
        .apicall(widget.type == 'donor' ? Urls().donor : Urls().beneficiary,
            data, context)
        .then((value) {
            ...
            : SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      id == 1
                          ? textfield(" ORGANIZATION NAME", orgname, 50)
                          : Container(),
                      id == 1
                          ? textfield("   ORGANIZATION REGISTRATION NUMBER",
                              orgregisterno, 50)
                          : Container(),
                      Container(
      ...
      children: [
        Align(
            ...
            child: Text(
              title,
              style: GoogleFonts.lato(
                  textStyle: TextStyle(fontSize: 10, letterSpacing: 0.5)),
            )),
        SizedBox(
          height: 5,
        ),
  ...
  registerbtn() {
    return Container(
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(6.0), color: Color.darkbluecolor),
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => PlacePicker(
          apiKey:
              "AIzaSyCxreoVeTIXYmCF0rtAy3UgeHjoMnsoVGU", // Put YOUR OWN KEY here.
  ...
  _getFromGallery(feature) async {
    ...
    final String filePath =
        dirPath + DateTime.now().microsecondsSinceEpoch.toString() + '.png';
