...
class _AddDonationState extends State<AddDonation> {
  ...
  adddonation() async {
    ...
    print("api call");
    await Api()
        .apicall(Urls().donor + "/" + id + "/donationItems", data, context)
        .then((value) {
  ...
  updateonation() async {
    ...
    await Api().call(widget.itemid, updatedata, context).then((value) {
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                  onTap: () {
                    widget.type == "old" ? updateonation() : adddonation();
                  },
                  child: widget.type == "old"
                      ? Text(
                          'UPDATE',
                          style: TextStyle(
                              fontSize: 12,
